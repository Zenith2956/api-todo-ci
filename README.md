...
# API TODO - CI/CD 
[![CI/CD Pipeline](https://github.com/Zenith2956/api-todo
ci/actions/workflows/ci-cd.yml/badge.svg)](https://github.com/Zenith2956/api
...
## API Déployée 
**URL :** https://api-todo-ci-arthur.onrender.com 
## Endpoints 
...
```bash 
curl https://api-todo-ci-arthur.onrender.com/todos 
``` 
### Créer un todo 
```bash 
curl -X POST https://api-todo-ci-arthur.onrender.com/todos \ -H "Content-Type: application/json" \ -d '{"title":"Apprendre le CI/CD"}' 
``` 
### Health check 
```bash 
curl https://api-todo-ci-arthur.onrender.com/health 
``` 
##      
Développement Local 
```bash 
