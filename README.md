...
[![Deploy Multi-Env](https://github.com/Zenith2956/api-todoci/actions/workflows/deploy-multi-env.yml/badge.svg)](https://github.com/VOTREUSERNAME/api-todo-ci/actions/workflows/deploy-multi-env.yml)
![Version](https://img.shields.io/github/v/tag/Zenith2956/api-todoci?label=version)
...
|---------------|-----|---------|--------|
| **Production** | [api-todo-ci-arthur-prod.onrender.com](https://api-todo-ci-arthur-prod.onrender.com/) | `main` | Actif |
| **Staging** | [api-todo-ci-arthur-staging.onrender.com](https://api-todo-ci-arthur-staging.onrender.com/) | `develop` | Actif |
---
...
|---------|-------|-------------|---------|
| GET | `/` | Infos de l'API | `curl https://api-todo-ci-arthur-prod.onrender.com//` |
| GET | `/todos` | Liste tous les todos | `curl https://api-todo-ci-arthur-prod.onrender.com//todos` |
| GET | `/todos/:id` | Un todo spécifique | `curl https://api-todo-ci-arthur-prod.onrender.com//todos/1` |
...
| GET | `/health` | Health check | `curl https://api-todo-ci-arthur-prod.onrender.com//health` |
---
## Tests
```bash
...
git clone https://github.com/Zenith2956/api-todo-ci.git
cd api-todo-ci
# Installer les dépendances
npm install
...
- Render.com
### Auteur
**Votre Prénom Nom** - [GitHub](https://github.com/Zenith2956)
---
## Ressources
